...
//
// Purpose: Adds full holster sequence and ironsights feature.
//
...
//	pOwner->EmitSound("<sound name goes here>"); // Uncomment this if you want to play a sound when ironsights are enabled.
	...
	{
// --------------------------------------------
// Disable the crosshair when using ironsights.
// --------------------------------------------
...
//	pOwner->EmitSound("<sound name goes here>"); // Uncomment this if you want to play a sound when ironsights are disabled.
	if (pOwner->SetFOV(this, 0, 0.4f)) // Modify the last value to adjust how fast the FOV is applied.
	{
// ---------------------------------------------
// Enable the crosshair when exiting ironsights.
// ---------------------------------------------
		ConVar* crosshair = cvar->FindVar("Crosshair");
