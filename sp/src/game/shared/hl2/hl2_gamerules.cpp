...
// FIXME: remove these - how about no?
...
ConVar	sk_max_slam				( "sk_max_slam","0", FCVAR_REPLICATED); // Uncommented.
//ConVar	sk_max_tripwire			( "sk_max_tripwire","0", FCVAR_REPLICATED);

// -------------------------
// Restored Molotov Convars.
// -------------------------
...
#ifdef HL2_EPISODIC
//ConVar	sk_max_hopwire			( "sk_max_hopwire", "3", FCVAR_REPLICATED); // Commented out.
ConVar	sk_max_striderbuster	( "sk_max_striderbuster", "3", FCVAR_REPLICATED);
#endif
ConVar	sk_max_hopwire("sk_max_hopwire", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 ); // Restored.
...
// -----------------------------------------------------------------
// Additions. Don't forget to add custom ConVar values to skill.cfg!
// -----------------------------------------------------------------
		def.AddAmmoType("SLAM", DMG_BURN, TRACER_NONE, 150, 75, 5, 0, 0);
